/*
 * Re-encodes the project images referenced from content/projects.ts as
 ...
 * - imgSrcSkinny: the filmstrip previews are gone, so nothing matches the
 *   skinny branch any more. It is kept because a preview variant is cheap to
 *   reintroduce and the rule is already written.
 *
 ...
 * is removed and content/projects.ts is updated to point at the .webp
 * file.
 */
...
const PROJECTS_FILE = path.join(ROOT, 'content', 'projects.ts');
